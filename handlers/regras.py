...
REGRAS = (
    "\n\n"
    "⚽ *Apostas:*\n"
    "- individuais para cada dia de jogos e podem ser feitas até as 12:00 PM. Jogos da madrugada do dia seguinte serão considerados como \"jogos do dia\". Exemplo: Austrália e Turquia, 14/06, 01:00 AM aparecerá para apostar no dia 13/06.\n"
    "- caso o apostador não faça aposta até as 12:00 PM, o robô 🤖 criará uma aposta aleatória com limite de até 3 gols para qualquer lado.\n"
...
def handle_regras(numero: str):
    enviar_texto(numero, f"*Regras do Bolão:*{REGRAS}")
    enviar_cta(numero)
